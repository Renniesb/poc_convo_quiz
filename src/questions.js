...
{     id:"2",
      ...
      questionText: "Tell me something about your family.",
      responseText: 'I have a <input autoComplete="off" id="blank3"> family, just me and my mother and father. But my <input autoComplete="off" id="blank4"> and aunts and <input autoComplete="off" id="blank5"> live very nearby, so we seem like a <input autoComplete="off" id="blank6"> family.',
      audioLink: audio2
},
{
      id:"3",
      ...
      questionText: "Tell me something about your family.",
      responseText: 'I recently got married, and my <input autoComplete="off" id="blank7"> and I live alone in a small apartment. But her <input autoComplete="off" id="blank8"> live nearby, and she has lots of <input autoComplete="off" id="blank9">. She’s very <input autoComplete="off" id="blank10"> to her family.',
      audioLink: audio3
},
{
      id:"4",
      ...
      questionText: "Tell me something about your family.",
      responseText: "I have a <input autoComplete='off' id='blank11'> brother. He is my only sibling, so ours is a <input autoComplete='off' id='blank12'> family. Most of our relatives live in another city, so we don't see them often. We have some <input autoComplete='off' id='blank13'> cousins who live near us but I don't know them well.",
      audioLink: audio4
},
{
      id:"5",
      ...
      responseText: "My brothers and sisters and I all enjoy <input autoComplete='off' id='blank14'>, so we spend a lot ot time playing soccer and tennis together. Also, we usually <input autoComplete='off' id='blank15'> our cousins every weekend and have a big <input autoComplete='off' id='blank16'> with them.",
      audioLink: audio5
},
{
      id:"6",
...
},
{
      ...
      questionText: "What do you enjoy doing with your family?",
      responseText: " We usually take a big family <input autoComplete='off' id='blank21'> every summer. We <input autoComplete='off' id='blank22'> a big house at the beach and <input autoComplete='off' id='blank23'> all our cousins to stay with us.",
      audioLink: audio7
},
{
      id:"8",
...
},
{
      ...
      responseText: "I like spending time with both family and friends. But to tell the truth, I have more <input autoComplete='off' id='blank28'> with my friends. My friends and I <input autoComplete='off' id='blank29'> a lot of <input autoComplete='off' id='blank30'>. That's why they're my friends.",
      audioLink: audio9
},
{
      id:"10",
      ...
      questionText: "Do you prefer spending time with your family or with friends?",
      responseText: "I have a new <input autoComplete='off' id='blank31'> so I don't have much time for friends. He takes most of my <input autoComplete='off' id='blank32'>. For now, my friends are my <input autoComplete='off' id='blank33'> and my son. That's <input autoComplete='off' id='blank34'> with me.",
      audioLink: audio10
},
{
      id:"11",
      ...
      questionText: "Do you prefer spending time with your family or with friends?",
      responseText: "I really enjoy spending time with my family. My brothers and sisters and I enjoy many of the same <input autoComplete='off' id='blank35'>. We have a lot <input autoComplete='off' id='blank36'>.",
      audioLink: audio11
},
{
      id:"12",
      ...
      questionText: "Do you prefer spending time with your family or with friends?",
      responseText: "I have a lot of friends, and I enjoy spending time with them. We go out together in large <input autoComplete='off' id='blank37'>. My friends are <input autoComplete='off' id='blank38'> a large family to me. I <input autoComplete='off' id='blank39'> better with my friends than I do with my family.",
      audioLink: audio12
},
{
      id:"13",
      ...
      responseText: "I like <input autoComplete='off' id='blank40'> all kinds of food. I especially like <input autoComplete='off' id='blank41'> from <input autoComplete='off' id='blank42'> countries. I always enjoy trying food that is new and <input autoComplete='off' id='blank43'>.",
      audioLink: audio13
},
{
      id:"14",
      ...
      questionText: "What kinds of food do you prefer to eat?",
      responseText: "I like the <input autoComplete='off' id='blank44'> my mother cooks. She cooks food that is <input autoComplete='off' id='blank45'> in our country. It's really <input autoComplete='off' id='blank46'>. Nobody cooks as <input autoComplete='off' id='blank47'> as my mother does.",
      audioLink: audio14
},
{
      id:"15",
      ...
      questionText: "What kinds of food do you prefer to eat?",
      responseText: "I am a <input autoComplete='off' id='blank48'>, so I never eat meat. I prefer food that's <input autoComplete='off' id='blank49'> with <input autoComplete='off' id='blank50'> vegetables. I eat a lot of <input autoComplete='off' id='blank51'>, too.",
      audioLink: audio15
},
{
      id:"16",
      ...
      questionText: "What kinds of food do you prefer to eat?",
      responseText: "I generally prefer to eat beef or <input autoComplete='off' id='blank52'> with <input autoComplete='off' id='blank53'>. And I love <input autoComplete='off' id='blank54'>. I like anything that's <input autoComplete='off' id='blank55'>. I almost never eat <input autoComplete='off' id='blank56'>.",
      audioLink: audio16
},
{
      id:"17",
      ...
      responseText: "I almost always eat at restaurants because I am <input autoComplete='off' id='blank57'> all day.",
      audioLink: audio17
},
{
      id:"18",
      ...
      questionText: "Do you usually eat at home or at restaurants?",
      responseText: "I always eat <input autoComplete='off' id='blank58'> and <input autoComplete='off' id='blank59'> at home, and I eat lunch at home, too, when I can. But on <input autoComplete='off' id='blank60'>, I often go to restaurants with my friends.",
      audioLink: audio18
},
{
      id:"19",
      ...
      questionText: "Do you usually eat at home or at restaurants?",
      responseText: "I usually eat at home because it's too <input autoComplete='off' id='blank61'> to eat at restaurants. I only <input autoComplete='off' id='blank62'> a meal at a restaurant when it's a <input autoComplete='off' id='blank63'>, for example, someone’s birthday.",
      audioLink: audio19
},
{
      id:"20",
      ...
      questionText: "Do you usually eat at home or at restaurants?",
      responseText: "I eat at home because it's more <input autoComplete='off' id='blank64'>. I have three children, so it's easier for us to eat at home. Also, there aren't many good restaurants in my <input autoComplete='off' id='blank65'>. I think the food we eat at home <input autoComplete='off' id='blank66'> better.",
      audioLink: audio20
},
{
      id:"21",
      ...
      responseText: "My favorite restaurant is a small place near my house. It <input autoComplete='off' id='blank67'> he most delicious <input autoComplete='off' id='blank68'>. It’s a great place to go for an afternoon <input autoComplete='off' id='blank69'>. I <input autoComplete='off' id='blank70'> meet my friends there.",
      audioLink: audio21
},
{
      id:"22",
      ...
      questionText: "What is your favorite restaurant?",
      responseText: "There is a very <input autoComplete='off' id='blank71'> restaurant downtown that has French food. I had my <input autoComplete='off' id='blank72'> dinner there last year. The <input autoComplete='off' id='blank73'> are high, so I can't go there very often, but I really like it.",
      audioLink: audio22
},
{
      id:"23",
      ...
      questionText: "What is your favorite restaurant?",
      responseText: "I like to go to a <input autoComplete='off' id='blank74'> restaurant near my school. I don't usually have a lot of time for lunch so it's a good place for me. I can get a <input autoComplete='off' id='blank75'> or a sandwich there and eat it <input autoComplete='off' id='blank76'>. It’s <input autoComplete='off' id='blank77'>, too.",
      audioLink: audio23
},
{
      id:"24",
      ...
      questionText: "What is your favorite restaurant?",
      responseText: "My favorite restaurant is a <input autoComplete='off' autoComplete='off' id='blank78'> restaurant near my house. I like it because I like <input autoComplete='off' autoComplete='off' id='blank79'>. It has lots of other kinds of food on the <input autoComplete='off' autoComplete='off' id='blank80'>, too.",
      audioLink: audio24
}
